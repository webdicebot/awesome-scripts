...
function getPayoutGo()
    ...
    if smartChance == 0 then return nil end
...
function workingBet()
    ...
    if normal and ((normal.tilethang >= 10 and normal.tilethang <= 30) or
        ...
        if go then
            ...
            log('default')
            -- Giữ nguyên giá trị mặc định nếu chưa tìm thấy kịch bản
        end
    end
